// Simplified PasskeyKit Integration for testing
import { PasskeyKit, PasskeyServer } from 'passkey-kit';
import { startRegistration, startAuthentication } from '@simplewebauthn/browser';

export class PasskeyIntegration {
  constructor(config) {
    console.log('PasskeyIntegration constructor called with config:', config);
    ...
    try {
      ...
      console.log('PasskeyServer initialized successfully');
